...
public class Tela_Funcionario extends JFrame {
	...
	public Tela_Funcionario() {
		...
		lblNome.setBounds(65, 68, 45, 13);
		contentPane.add(lblNome);
		
		Nome = new JTextField();
		Nome.setBounds(115, 65, 152, 19);
		contentPane.add(Nome);
		Nome.setColumns(10);
		
		JLabel lblEmail = new JLabel("Email");
		lblEmail.setBounds(65, 122, 45, 13);
		contentPane.add(lblEmail);
		
		Email = new JTextField();
		Email.setBounds(115, 119, 152, 19);
		Email.setColumns(10);
		...
		btnConfirmar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Funcionario fun = new Funcionario(Nome.getText(), Email.getText(), 
						Cargo.getText());
