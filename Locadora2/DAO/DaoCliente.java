...
public class DaoCliente {
	...
	public void criarCl(Cliente_Api c1) {
    	this.c1=c1;
        Connection con = null;
        try {
	...
	public void deletarCl(Cliente_Api c1) {
    	this.c1=c1;
        Connection con = null;
        try {
            con = ConnectionManager.getConnection();
	...
	public void atualizarCl(Cliente_Api c1) {
		this.c1=c1;
        Connection con = null;
        try {
            con = ConnectionManager.getConnection();
    ...
    public List<Cliente_Api> buscarClientes(Cliente_Api c1) {
    	this.c1=c1;
