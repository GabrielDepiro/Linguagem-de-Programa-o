...
public class DaoEscolha_Dados {
	...
	public DaoEscolha_Dados(Cliente_Api c1, Dados d1, Dados t1, Dados t2, Dados t3, Dados t4, Dados t5, Dados t6, Dados t7) {
		this.c1=c1;	
		this.d1=d1;
		this.t1=t1;
		this.t2=t2;
	...
	public List<Cliente_Api> buscarEscolhaProduto(Cliente_Api c1) {
    	this.c1=c1;
